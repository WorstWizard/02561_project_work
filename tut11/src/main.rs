...
fn init_vulkan(window: &Window) -> VulkanApp {
    ...
    //// Graphics pipeline
    let (graphics_pipeline_layout, renderpass) = {
        //// Render pass
        ...
        let viewport = vk::ViewportBuilder::new()
            ...
            .min_depth(0.0)
            .max_depth(1.0);
        let scissor_rect = vk::Rect2DBuilder::new()
        ...
        let pipeline_color_blend_attachment_state = vk::PipelineColorBlendAttachmentStateBuilder::new()
            .color_write_mask(
        ...
        //The shader modules can therefore be destroyed now already
        unsafe {
